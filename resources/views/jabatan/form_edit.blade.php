...
@stop
@section('content')
 <!-- Ini Konten Form Edit Jabatan  -->
@foreach($data as $rs)
    <form method="POST" action="{{ route('jabatan.update',$rs->id) }}">
@csrf 
<!-- security untuk menghindari dari serangan pada saat input form -->
@method('put') 
<!--  method put digunakan untuk meletakkan data yang akan diubah disetiap element form edit jabatan  -->
    ...
    <a class="btn btn-info float-right" href="{{ url('/jabatan') }}" role="button">Back&nbsp;&nbsp;<i class="fa fa-arrow-left"></i></a>
